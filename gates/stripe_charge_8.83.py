...
r1 = this.curlx.Get('https://protprintnline.net/stainless-steel-hose-clamp', null, cookie, server['proxy']);
...
r3 = this.curlx.Get('https://protprintnline.net/checkout/', null, cookie, server['proxy']);
...
data = '{"addressInformation":{"shipping_address":{"countryId":"US","regionId":"43","regionCode":"NY","region":"New York","street":["12 main street"],"company":"","telephone":"2564567654","postcode":"10509","city":"Brewster","firstname":"'.fake.first.'","lastname":"'.fake.last.'","extension_attributes":{"shipperhq_option_values":{"destination_type":"","inside_delivery":"0","liftgate_# required":"0","limited_delivery":"0","notify_# required":"0","customer_carrier":"","customer_carrier_ph":"","customer_carrier_account":""}}},"billing_address":{"countryId":"US","regionId":"43","regionCode":"NY","region":"New York","street":["12 main street"],"company":"","telephone":"2564567654","postcode":"10509","city":"Brewster","firstname":"'.fake.first.'","lastname":"'.fake.last.'","saveInAddressBook":null},"shipping_method_code":"GND","shipping_carrier_code":"shqups2","extension_attributes":{}}}';
...
r4 = this.curlx.Post('https://protprintnline.net/rest/pto/V1/guest-carts/'.entity_id.'/shipping-information', data, headers, cookie, server['proxy']);

if (!r4.success) goto start;

r5 = this.curlx.Get('https://protprintnline.net/rest/pto/V1/stripe/payments/get_client_secret', null, cookie, server['proxy']);
